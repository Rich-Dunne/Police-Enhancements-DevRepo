...
namespace RichsPoliceEnhancements.Utils
{
    ...
    internal static class VehicleExtension
    {
        ...
        internal static void ToggleNeonLight(this Vehicle vehicle, ENeonLights neonLight, bool toggle)
        {
        ...
        internal static void SetNeonLightsColor(this Vehicle vehicle, Color color)
        {
        ...
        internal static bool IsNeonLightEnable(this Vehicle vehicle, ENeonLights neonLight)
        {
        ...
        internal static Color GetNeonLightsColor(this Vehicle vehicle)
        {
            return UnsafeGetNeonLightsColor(vehicle);
        }
        internal static Color UnsafeGetNeonLightsColor(Vehicle vehicle)
        {
            Color color;
            int red = 0;
            int green = 0;
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        internal static VehicleColor GetColors(this Vehicle v)
        {
            return GetVehicleColors(v);
        }

        private static VehicleColor GetVehicleColors(Vehicle vehicle)
        {
            NativeFunction.Natives.xA19435F193E081AC(vehicle, out int colorPrimaryInt, out int colorSecondaryInt);
        ...
        internal static void SetColors(this Vehicle v, EPaint primaryColor, EPaint secondaryColor)
        {
        ...
        internal static void SetColors(this Vehicle v, VehicleColor color)
        {
